        ...
        <main className="w-full flex flex-col items-center">
            ...
            <section className="flex flex-col flex-wrap w-full">
                ...
                <form className="w-full flex flex-col items-center mt-8">
                    <div className="w-11/12 flex flex-col items-center">
                        ...
                        <div className=" flex flex-col w-full sm:w-80">
                            ...
                            <input className="border-2 border-solid border-[#A4A4A4] sm:w-80 p-2 rounded-xl" type="password" name="newPassword" placeholder="User password" />
                        </div>

                        <div className=" flex flex-col w-full sm:w-80">
                            <label className="p-2">New password repetition:</label>
                            <input className="border-2 border-solid border-[#A4A4A4] sm:w-80 p-2 rounded-xl" type="password" name="newPasswordRepetition" placeholder="User password" />
                        </div>
                ...
                <div className="flex flex-col items-center mt-10">
                    <button className="text-red-600 font-bold">Log Out <img className="inline" src="./icons/logOut.png" /></button>
                </div>
            </section>
        </main>
        <Footer />
